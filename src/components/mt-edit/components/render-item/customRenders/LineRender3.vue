  ...
  >
    ...
    <g>
      ...
      <path
        ...
        fill="none"
        stroke="rgba(64,122,144,0.8)"
        :stroke-width="lineRenderProps.itemJson.props['stroke-width'].val * 5"
      ...
      <path
        ...
        :stroke-width="(lineRenderProps.itemJson.props['stroke-width'].val * 5) / 3"
        stroke-linecap="round"
        stroke-linejoin="round"
